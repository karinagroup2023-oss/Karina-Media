...
- **Юрлицо:** ТОО на общеустановленном режиме налогообложения (НЕ ИП). Важно для договоров, оферт, счетов, налогов (НДС при превышении порога), сигналов доверия в продающих материалах — везде «ТОО», не «ИП».
...
- **Прайс v2 (07.07.2026):** линейка заменила прайс целиком — Старт 250К / Бизнес 490К (ХИТ) / VIP от 890К (две комплектации: «Магазин» с админкой или «Воронка») + подписка «На связи» 50К/мес. Оплата Kaspi/Halyk — всегда этапом 2 (эквайринг подписывает клиент с банком). Кейс ФерМамы подавать как «проверенная модель рынка», НЕ как нашего клиента. Дизайн-док: `Karina-Media/sales-kit/2026-07-07-product-line-v2-design.md`.

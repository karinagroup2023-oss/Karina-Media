...
const PRICES = `💰 <b>Цены KARINA Media</b>

🟢 <b>Старт — витрина + заявки — 250 000 ₸</b> · 3–5 дней
Мини-приложение с каталогом: клиент выбирает — заявка с составом падает вам в WhatsApp.

🟡 <b>Бизнес — магазин + база клиентов — 490 000 ₸</b> · 5–7 дней <i>(хит)</i>
Корзина, доставка и самовывоз, автосообщения, база клиентов с выгрузкой в Excel, аналитика.

🔴 <b>VIP — система продаж под ключ — от 890 000 ₸</b> · 10–14 дней
«Магазин»: своя админ-панель + обучение команды — или «Воронка»: квиз + сайт + бот. Оплата Kaspi / Halyk — этапом 2.

🔁 <b>Подписка «На связи» — 50 000 ₸/мес</b>
Правки, акции и рассылки нашими руками. Первый месяц в подарок к Бизнес и VIP.

📱 Приложение одно — каналы любые: <b>WhatsApp + веб, Instagram, Telegram</b>. Гибрид — без доплаты.
...
function mainMenu() {
  return new InlineKeyboard()
    .webApp("Открыть портфолио KARINA", "https://portfolio-app-sooty-three-71.vercel.app/?ref=bot").row()
